...
class Evaluation
{
    ...
    private ?\DateTimeInterface $dateEvalution = null;
    ...
    public function getDateEvalution(): ?\DateTimeInterface
    {
        return $this->dateEvalution;
    }

    public function setDateEvalution(\DateTimeInterface $dateEvalution): static
    {
